        ...
        >
          <template v-slot:top>
            <div class="col-6 row justify-start">
              <!-- <q-input dense debounce="300" v-model="filter" placeholder="Search driver or route" input-class="text-white" color="blue-7" style="width:168px;" >
              ...
              <q-select
                ...
                class="text-white q-mr-xs q-select-list"
              >
...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'dpdPayType', required: true, label: 'PAY TYPE', align: 'left', field: 'dpdPayType' },
  ...
  methods: {
    ...
    getDpdPerformanceList: async function (props) {
      ...
      Loading.show()
      try {
        let res = await api.getDpdPerformanceList(params)
        Loading.hide()
    ...
    getDpdPerformanceAll: async function (props) {
      ...
      Loading.show()
      try {
        let res = await api.getDpdPerformanceAll(params)
        Loading.hide()

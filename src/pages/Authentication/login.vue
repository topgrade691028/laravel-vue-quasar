  ...
  <div id="bgImage" style="display: flex">
    ...
    <div class="q-pa-md text-center" style="margin: auto">
      ...
      >
        <div class="q-my-md">
          <img
            :src="require('../../assets/images/ukcourier_logo.svg')"
        ...
        <!-- <a href="/driver-login">Login with Driver</a> -->
      </q-form>
    </div>
  </div>
</template>
    ...
    async login() {
      ...
      try {
        ...
        if (res.data.user_type === "user") {
          ...
          this.$store.commit("auth/userSubcontractor", res.data.user.subcontractor);
          if (userType !== 'admin') {
            if (res.data.user.subcontractor === "Regular") {
          ...
          this.$store.commit("auth/token", res.data.token);
          this.$store.commit("auth/driver", res.data.user);
          this.$store.commit("auth/userSubcontractor", res.data.user.user.subcontractor);
          this.$store.commit("auth/userLevel", "driver");
          if (res.data.user.user.subcontractor === "Regular") {

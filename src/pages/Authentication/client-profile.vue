        ...
        >
          <q-card style="background-color: #3E444E; box-shadow: none">
            ...
            <q-card-section class="text-left q-py-none">
              ...
              <q-input dense outlined required bg-color="white" color="blue-7" class="q-pb-md" input-class="text-black text-center" v-model="userForm.depot_location"></q-input>
            </q-card-section>
            <q-card-section class="text-left q-py-none">
            ...
            <!-- <q-card-section class="text-left q-py-none">
              ...
              <q-select
                ...
                bg-color="white"
                class="q-pb-md"
                v-model="userForm.subcontractor"
            ...
            <q-card-section class="text-left q-py-none">
              ...
              <q-input dense outlined required bg-color="white" color="blue-7" class="q-pb-md" input-class="text-black text-center" v-model="userForm.address"></q-input>
            </q-card-section>
            <q-card-section class="text-left q-py-none">
            ...
            <q-card-section class="text-left q-py-none">
              ...
              <q-input dense outlined required bg-color="white" color="blue-7" class="q-pb-md" input-class="text-black text-center" v-model="userForm.country"></q-input>
            </q-card-section>
            <q-card-section class="text-left q-py-none">
            ...
            <q-card-section class="text-left q-py-none">
                <q-checkbox v-model="isChangePassword" :val="true" label="Do you want to change your password?" class="q-mx-auto text-white" color="grey" dark />
              </q-card-section>
